...
# **convertToBmp**
> string convertToBmp($image_file)
...
# **convertToGif**
> string convertToGif($image_file)
...
# **convertToJpg**
> string convertToJpg($quality, $image_file)
...
> object convertToJpgDefaultQuality($image_file)
...
try {
    $result = $apiInstance->convertToJpgDefaultQuality($image_file);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ConvertApi->convertToJpgDefaultQuality: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
# **convertToPhotoshop**
> string convertToPhotoshop($image_file)
...
try {
    $result = $apiInstance->convertToPhotoshop($image_file);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ConvertApi->convertToPhotoshop: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
# **convertToPng**
> string convertToPng($image_file)
...
# **convertToTiff**
> string convertToTiff($image_file)
...
try {
    $result = $apiInstance->convertToTiff($image_file);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ConvertApi->convertToTiff: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
# **convertToWebP**
> string convertToWebP($image_file)
...
try {
    $result = $apiInstance->convertToWebP($image_file);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ConvertApi->convertToWebP: ', $e->getMessage(), PHP_EOL;
}
?>
```

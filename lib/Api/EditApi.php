...
class EditApi
{
    ...
    protected function editCompositeBasicRequest($location, $base_image, $layered_image)
    {
        ...
        if ($layered_image === null || (is_array($layered_image) && count($layered_image) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if ($layered_image !== null) {
            $multipart = true;
            $formParams['layeredImage'] = \GuzzleHttp\Psr7\Utils::tryFopen(ObjectSerializer::toFormValue($layered_image), 'rb');
        }
        // body params
        $_tempBody = null;
    ...
    protected function editContrastAdaptiveRequest($gamma, $image_file)
    {
        ...
        if ($gamma === null || (is_array($gamma) && count($gamma) === 0)) {
            throw new \InvalidArgumentException(
    ...
    protected function editCropCircleRequest($left, $top, $radius, $image_file)
    {
        ...
        if ($left === null || (is_array($left) && count($left) === 0)) {
            throw new \InvalidArgumentException(
